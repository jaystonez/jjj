...
<script>
	jQuery(document).ready(function() {
		...
		jQuery( '.bb_destination-new-item a' ).click( function(e){
			...
			sendURL = '<?php echo pb_backupbuddy::ajax_url( 'destination_picker' ); ?>&add=' + jQuery(this).attr('rel') + '&filter=' + jQuery(this).attr('rel') + '&callback_data=' + jQuery('#pb_backupbuddy_archive_send').attr('rel') + '&sending=1';
			alert( sendURL );
			jQuery.post( sendURL, 
				function(data) {
...
foreach( pb_backupbuddy::$options['remote_destinations'] as $destination_id => $destination ) {
	$destinationTabs[] = array(
		...
		'slug'		=>		'destination_' . $destination['type'],
	);
}
...
foreach( pb_backupbuddy::$options['remote_destinations'] as $destination_id => $destination ) {
	pb_backupbuddy::$ui->start_tab( 'destination_' . $destination['type'] );
